...
def main(args):
    ...
    # Start Training 
    for epoch in range(start_epoch, 1):  # constantly 1 epoch
        ...
        for i, (images, captions, lengths, _, _, T) in enumerate(data_loader):
            ...
            if i > 25:  # constantly max iter is 25
                print("Break at 25 iter.")
                break
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrained_cnn', type=str, default='models/pretrained_cnn.pkl',
                        help='load pertraind_cnn parameters')
    parser.add_argument('--num_epochs', type=int, default=30)
    parser.add_argument('--batch_size', type=int, default=80)
    parser.add_argument('--num_workers', type=int, default=4)
    parser.add_argument('--clip', type=float, default=0.1)
    parser.add_argument('--visual_attention_epoch', type=int, default=20,
                        help='epoch at which to start training visual_attention')
    ...
    main(args)
    pr.disable()
    pr.dump_stats(os.path.join(args.model_path, "train.profile"))
